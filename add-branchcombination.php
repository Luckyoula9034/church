...
$status=1;
$sql="INSERT INTO  branchcombination(assemblyId,branchId,status) VALUES(:assemblyId,:branchId,:status)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin branch Combination< </title>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="assembly" class="form-control" id="default" required="required">
...
{   ?>
<option value="<?php echo htmlentities($eulogy->id); ?>"><?php echo htmlentities($eulogy->name); ?>&nbsp; location-<?php echo htmlentities($eulogy->location); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
...
foreach($results as $eulogy)
{   ?>
<option value="<?php echo htmlentities($eulogy->id); ?>"><?php echo htmlentities($eulogy->branchName); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
