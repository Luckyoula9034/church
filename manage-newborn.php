...
<html lang="en">
    <head>
        ...
        <title>Admin Manage newborn</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage newborns</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> newborns</li>
            							<li class="active">Manage newborns</li>
            						</ul>
                                </div>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->newbornName);?></td>
                                                            <td><?php echo htmlentities($result->notificationNo);?></td>
