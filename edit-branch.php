...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Update branch </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update branch</h2>
...
{   ?>                                               
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="branchname" value="<?php echo htmlentities($eulogy->branchName);?>" class="form-control" id="default" placeholder="branch Name" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Code</label>
                                                        <div class="col-sm-10">
 <input type="text" name="branchcode" class="form-control" value="<?php echo htmlentities($eulogy->branchCode);?>"  id="default" placeholder="branch Code" required="required">
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
