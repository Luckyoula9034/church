...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update newborns set newbornName=:studentname,notificationNo=:roolid,fatherEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where id=:stid ";
...
$msg="newborns info updated successfully";
}
...
<html lang="en">
    <head>
        ...
        <title>church Admin| Edit newborn < </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Newborn updation</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Newborn updation</li>
                                    </ul>
                                </div>
...
$sql = "SELECT newborns.newbornName,newborns.notificationNo,newborns.RegDate,newborns.id,newborns.Status,newborns.fatherEmail,newborns.Gender,newborns.DOB,assembly.name,assembly.location from newborns join assembly on assembly.id=newborns.assemblyId where newborns.id=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" value="<?php echo htmlentities($result->newbornName)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->notificationNo)?>" maxlength="10" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="email" name="emailid" class="form-control" id="email" value="<?php echo htmlentities($result->fatherEmail)?>" required="required" autocomplete="off">
</div>
</div>
