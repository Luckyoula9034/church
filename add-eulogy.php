...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  membersummary(memberId,assemblyId,branchId,age) VALUES(:studentid,:class,:sid,:marks)";
...
if($lastInsertId)
{
$msg="member summary added successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>secretary| Add member summary </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare member summary</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">member summary</li>
                                    </ul>
                                </div>
