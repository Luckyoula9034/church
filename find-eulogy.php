                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="eulogy.php" method="post">
                                	<div class="form-group">
                                		<label for="idNo">Enter your IdNo</label>
                                        <input type="text" class="form-control" id="idNo" placeholder="Enter your IdNo" autocomplete="off" name="idNo">
                                	</div>
                               <div class="form-group">
...
{   ?>
<option value="<?php echo htmlentities($eulogy->id); ?>"><?php echo htmlentities($eulogy->name); ?>&nbsp; name-<?php echo htmlentities($eulogy->name); ?></option>
<?php }} ?>
 </select>
</div>
