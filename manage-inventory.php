...
<html lang="en">
    <head>
        ...
        <title>Admin Manage inventories</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage inventories</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> inventories</li>
            							<li class="active">Manage inventories</li>
            						</ul>
                                </div>
