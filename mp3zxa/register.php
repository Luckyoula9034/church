    ...
    $shortcode='600227';
    $consumerkey    ="G78Z9BzWg6IqPBXziVZdAQuSyFQxpFsZ";
    $consumersecret ="tUlA0c3ilhBwUaJA";
    $validationurl="http://localhost/church/mp3zxa/validation.php?token=l4cE4wsqYOciXvQ$";
    $confirmationurl="http://localhost/church/mp3zxa/confirmation.php?token=l4cE4wsqYOciXvQ$";
